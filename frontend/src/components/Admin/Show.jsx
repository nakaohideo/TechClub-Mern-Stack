...
const ShowPosts = () => {
  ...
  const handleDeleteComment = (postId, commentIndex) => {
    axios
      .delete(
        `https://ctc-website-server-api.onrender.com/Post/${postId}/comment/${commentIndex}`
      )
      .then(() => {
                        ...
                        {post.comments.map((comment, index) => (
                          ...
                          >
                            <p className="text-start bg-white w-full p-2 text-[12px] flex justify-between overflow-scroll h-[50px]">
                              ...
                              <button
                                className="bg-blue-500 p-2 text-[12px] text-white font-semibold hover:bg-blue-700"
                                onClick={() =>
