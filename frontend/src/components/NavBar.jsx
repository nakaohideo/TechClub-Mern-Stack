...
const NavigationBar = () => {
  ...
  return (
    <nav className=" p-5 nav bg-slate-900">
      <div className="flex items-center justify-between relative ">
        <div className="flex items-center">
            <h1 className='text-xl lg:text-2xl text-white font-poppins font-bold'>CTC</h1>
  ...
  <NavLink
    to="/contact"
    className={`bg-blue-500 p-3 text-white font-poppins font-semibold invisible lg:visible rounded hidden lg:block ${location.pathname === "/contact" ? 'active' : ''}`}
  >
    Contact
  </NavLink>
</div>
<button className="text-white lg:hidden" onClick={toggleMenu}>
      ...
      {menuOpen && (
        <div className="lg:hidden m-auto w-full flex flex-col items-center border-b-2 border-white shadow-md justify-center absolute top-15 right-0 z-10 bg-slate-900">
          <div className="block text-white font-semibold mb-2">
            <NavLink
              to="/Home"
              className={`relative w-fit text-white block font-semibold ...`}
